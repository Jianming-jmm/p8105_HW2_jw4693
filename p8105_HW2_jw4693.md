...
is 0 row in the result data being lost, so the data is correct.
...
```
    ...
    ##   series episode baker    signature_bake           show_stopper technical result
    ##    <dbl>   <dbl> <chr>    <chr>                    <chr>            <dbl> <chr> 
    ## 1      2       1 "\"Jo\"" Chocolate Orange Cupcak… Chocolate a…        NA <NA>  
    ## 2      2       2 "\"Jo\"" Caramelised Onion, Gruy… Raspberry a…        NA <NA>  
    ## 3      2       3 "\"Jo\"" Stromboli flavored with… Unknown             NA <NA>  
    ## 4      2       4 "\"Jo\"" Lavender Biscuits        Blueberry M…        NA <NA>  
    ## 5      2       5 "\"Jo\"" Salmon and Asparagus Pie Apple and R…        NA <NA>  
    ## 6      2       6 "\"Jo\"" Rum and Raisin Baked Ch… Limoncello …        NA <NA>  
    ## 7      2       7 "\"Jo\"" Raspberry & Strawberry … Pain Aux Ra…        NA <NA>  
    ## 8      2       8 "\"Jo\"" Raspberry and Blueberry… Mini Victor…        NA <NA>
...
![](p8105_HW2_jw4693_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
